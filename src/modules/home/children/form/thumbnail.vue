<template>
  <div class="wrapper">
    <demo title="缩略图展示" :vertical="true">
      <div slot="demo">
        <c-form
          :cells="cells"
...
<script>
  import code from 'code/form/img-uploader'
  ...
  export default {
    data () {
      return {
        ...
        initialData: {
          thumbnail1: 'b9ab7d42-755f-4483-b37f-2188987e1abd',
          thumbnail2: ['b9ab7d42-755f-4483-b37f-2188987e1abd', 'b9ab7d42-755f-4483-b37f-2188987e1abd']
        },
        formRst: ''
      }
    },
